module.exports = {
  ...
  execute(message, args) {
    ...
    else if (args === "owned") {message.channel.send("https://www.youtube.com/watch?v=Q_7NSXnlQ64&t=463s");}
    else if (args === "queen") {const v1 = "https://www.youtube.com/watch?v=YT0PYyUYi0Y";
    ...
    else if (args === "snl") {message.channel.send("https://www.youtube.com/watch?v=Frud5RFtTi0");}
