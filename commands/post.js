module.exports = {
  ...
  execute(message, args) {
    ...
    if (args === "owned") {message.channel.send("https://www.youtube.com/watch?v=Q_7NSXnlQ64&t=463s");}
    if (args === "queen") {    const v1 = "https://www.youtube.com/watch?v=YT0PYyUYi0Y";
    ...
    if (args === "snl") {message.channel.send("https://www.youtube.com/watch?v=Frud5RFtTi0");}
  }
  },
};
